        ...
        private Record fetchNextRecord()
        {
            ...
            while (true) {
                ...
                if (this.rightRecord!=null && compare(this.leftRecord, this.rightRecord) == 0) {
                    Record x = this.leftRecord.concat(this.rightRecord);
                    if (this.rightIterator.hasNext()) {
            ...
            //return the next record that sortmerge join outputs otherwise return null
//terminates when no more records in left table
